    ...
    if file is not None:
        if not filtereddf.empty:
            ...
            if covariates:
                ...
                predCovariates = [c for c in colNames if c in filtereddf.columns]
                predInputCols = predCovariates + [eventCol, eventObservedCol]
                predCoxdf = filtereddf[predInputCols].copy(deep=True)
